...
const newProduct = async () => {
  producto.value.categoria = producto.value.categoria.id
  producto.value.marcaVehiculo = producto.value.marcaVehiculo.make.id
  producto.value.modeloVehiculo = producto.value.modeloVehiculo.id
  producto.value.tipoVehiculo = producto.value.tipoVehiculo.id
  ...
  try {
    const response = await data({
      ...
      modeloVehiculo: producto.value.modeloVehiculo,
      tipoVehiculo: producto.value.tipoVehiculo,
      marcaVehiculo: producto.value.marcaVehiculo
    });
        ...
        <form @submit.prevent="newProduct()" class="space-y-6">
          ...
          <div class="flex space-x-4">
            <div class="w-1/2">
              ...
              <Select v-model="producto.marcaVehiculo" :options="marca" optionLabel="name" placeholder="Marca"
                class="mt-1 w-full border-gray-300 rounded-md shadow-sm" id="marca-vehiculo" />
            </div>
            <div class="w-1/2">
          ...
          <div class="flex space-x-4">
            <div class="w-1/2">
              ...
              <Select v-model="producto.tipoVehiculo" :options="tipoVehiculo" optionLabel="name"
                placeholder="Tipo de vehiculo" class="mt-1 w-full border-gray-300 rounded-md shadow-sm"
                id="tipo-vehiculo" />
            </div>
          </div>
          <div>
