        ...
        <nav class="m-2 w-full">
          <div class="flex items-center font-mono" role="navigation">
            ...
            <div class="flex grow">
              ...
              <button class="relative flex items-center rounded-l-none uppercase focus:ring-0" type="button">
            ...
            <div class="hidden grow md:block">
              <ul class="flex items-center justify-evenly">
                <li class="mx-1">
                  <RouterLink :to="{ name: 'contactview' }" class="text-white ">Contáctenos</RouterLink>
                </li>
                <li class="mx-1">
                  <RouterLink :to="{ name: 'productosview' }" class="text-white ">Productos</RouterLink>
                </li>
                <li class="mx-1">
                  <RouterLink :to="{ name: 'loginview' }" class="text-white ">Ingresar</RouterLink>
                </li>
              </ul>
            </div>
          </div>
