        ...
        <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
          <div>
            ...
            <p class="">
              ...
              sobre medidas para carros - kit de carretera - techos
              corredizos.
            </p>
            <div class="flex">
          ...
          <div class="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:col-span-2 lg:grid-cols-3">
            ...
            <div>
              ...
              <nav class="flex flex-col">
                <a class="uppercase">
                  PELÍCULAS DE SEGURIDAD Y POLARIZADO
                </a>
                <a class="uppercase"> TAPIZADO DE TIMÓN </a>
                <a class="uppercase"> VIDEO </a>
              </nav>
            </div>
            <div>
              <p class="">Nosotros</p>
              <nav class="flex flex-col">
                <a href="https://maps.app.goo.gl/h9HVh8ScHYLAiizA8" class="uppercase">
